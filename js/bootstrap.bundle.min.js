...
!(function (t, e) {
  ...
  for (
    var r,
      ...
      mt =
        ...
        (a = "." + (o = "bs.alert")),
        (l = (r = e).fn[n]),
        (f = { CLOSE: "close" + a, CLOSED: "closed" + a, CLICK_DATA_API: "click" + a + ".data-api" }),
        (h = "alert"),
        (u = "fade"),
        (d = "show"),
        (p = (function () {
      ...
      _t =
        ...
        (A = ".active"),
        (S = ".btn"),
        (O = { CLICK_DATA_API: "click" + v + E, FOCUS_BLUR_DATA_API: (C = "focus") + v + E + " blur" + v + E }),
        (N = (function () {
          function n(t) {
            this._element = t;
          }
      ...
      Et =
        ...
        (st = { SHOW: "show" + nt, SHOWN: "shown" + nt, HIDE: "hide" + nt, HIDDEN: "hidden" + nt, CLICK_DATA_API: "click" + nt + ".data-api" }),
        (at = "show"),
        (lt = "collapse"),
        (ct = "collapsing"),
        (ft = "collapsed"),
  ...
  function Rt(t, e, n, i) {
    return Math.max(
      ...
      n["offset" + t],
      n["scroll" + t],
      Nt(10) ? n["offset" + t] + i["margin" + ("Height" === t ? "Top" : "Left")] + i["margin" + ("Height" === t ? "Bottom" : "Right")] : 0
    );
  }
  function Mt() {
    var t = document.body,
      ...
      modifiers: {
        ...
        arrow: {
          ...
          fn: function (t, e) {
            ...
            return (
              (E = Math.max(Math.min(s[c] - p, E), 0)), (t.arrowElement = i), (t.offsets.arrow = (Ft((n = {}), h, Math.round(E)), Ft(n, u, ""), n)), t
            );
          },
          element: "[x-arrow]",
        },
            ...
            return (
              y.forEach(function (t, e) {
                ...
                var n,
                  ...
                  d =
                    !!g.flipVariations &&
                    ((u && "start" === E && a) || (u && "end" === E && l) || (!u && "start" === E && c) || (!u && "end" === E && f));
                (s || h || d) &&
                  ((p.flipped = !0),
                  (s || h) && (_ = y[e + 1]),
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            var s = void 0 !== o ? o : e.gpuAcceleration,
              ...
              d = void 0,
              p = void 0;
            if (((p = "bottom" === f ? -a.height + c.bottom : c.top), (d = "right" === h ? -a.width + c.right : c.left), s && u))
            ...
            return (
              (t.attributes = Ut({}, _, t.attributes)), (t.styles = Ut({}, l, t.styles)), (t.arrowStyles = Ut({}, t.offsets.arrow, t.arrowStyles)), t
            );
          },
          gpuAcceleration: !0,
          x: "bottom",
  ...
  var ge,
                  ...
                  if (!this._inNavbar) {
                    ...
                    "parent" === this._config.reference
                      ...
                      : gt.isElement(this._config.reference) &&
                        ((r = this._config.reference), "undefined" != typeof this._config.reference.jquery && (r = this._config.reference[0])),
          ...
          (l._dataApiKeydownHandler = function (t) {
            if (
              (/input|textarea/i.test(t.target.tagName)
                ? !(32 === t.which || (27 !== t.which && ((40 !== t.which && 38 !== t.which) || ge(t.target).closest(Le).length)))
                : be.test(t.which)) &&
        ...
        return (
          ...
          (t._fixTransition = function () {
            ...
            null === t.getAttribute("x-placement") &&
              (sn(t).removeClass(En), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e));
          }),
          (i._jQueryInterface = function (n) {
            return this.each(function () {
    ...
    Ii =
      ...
      (Xn = { ACTIVATE: "activate" + Yn, SCROLL: "scroll" + Yn, LOAD_DATA_API: "load" + Yn + ".data-api" }),
      (Jn = "dropdown-item"),
      (Zn = "active"),
      ($n = {
      ...
      (ni = (function () {
        ...
        return (
          ...
          (t._activate = function (e) {
            ...
            var n = Kn(t.join(","));
            n.hasClass(Jn)
              ? (n.closest($n.DROPDOWN).find($n.DROPDOWN_TOGGLE).addClass(Zn), n.addClass(Zn))
              : (n.addClass(Zn),
                n
              ...
              Kn(this._scrollElement).trigger(Xn.ACTIVATE, { relatedTarget: e });
          }),
          (t._clear = function () {
    ...
    Di =
      ((oi = "." + (ri = "bs.tab")),
      (si = (ii = e).fn.tab),
      (ai = { HIDE: "hide" + oi, HIDDEN: "hidden" + oi, SHOW: "show" + oi, SHOWN: "shown" + oi, CLICK_DATA_API: "click" + oi + ".data-api" }),
      (li = "dropdown-menu"),
      (ci = "active"),
      (fi = "disabled"),
      (hi = "fade"),
      ...
      (yi = (function () {
        ...
        return (
          (t.show = function () {
            ...
            if (
              !(
                (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && ii(this._element).hasClass(ci)) ||
